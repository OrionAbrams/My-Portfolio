    ...
    <div className="very-high">
      <div className="row">
        <div className="col-md-11">
          ...
          <p className="bio">
            <Link target="_blank" className="contact-links text-dark" to="//docs.google.com/document/d/e/2PACX-1vQnYKLH_G1Gir7P9z0J6wZvUPZbIWCUkSFzOO-0fE1MiCbGoua5f_vd9FrDjYv7Vshl92xbuHsTly0i/pub"> Resume / </Link>
